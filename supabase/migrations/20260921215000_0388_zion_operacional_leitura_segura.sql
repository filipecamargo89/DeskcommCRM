-- 0388: leitura segura do Zion Operacional.
-- Remove a necessidade de SELECT direto do navegador em credit_proposals.
-- Nunca retorna ciphertext, IV, tag ou notes na listagem.
